...
- **Exposes**: `NewModel(client) → *Model`, implements `tea.Model` interface
- **Guarantees**: Pending changes tracked until explicit Apply. Filter preserves selection when possible.
